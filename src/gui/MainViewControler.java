...
public class MainViewControler implements Initializable {
	...
	private synchronized void loadView2(String absoluteName) {
		try {
			...
			DepartmentListViewControler departmentListViewControler=loader.getController(); 
			departmentListViewControler.setDepartmentService(new DepartmentService());
			departmentListViewControler.updateTableView();
